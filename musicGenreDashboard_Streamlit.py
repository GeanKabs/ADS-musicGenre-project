...
st.write('Write in the box: Joeboy-Alcohol.mp3 ,and : RudeBoy-Reason-With-Me.mp3 ,second time')
src = st.text_input("In: ", )
#st.write('Indicate full path, inclduing name of the audio ending with .wav')
st.write('Write in the box: audio_test2/Joeboy-Alcohol.wav ,and: auido_test2/RudeBoy-Reason-With-Me.wav ,second time')
